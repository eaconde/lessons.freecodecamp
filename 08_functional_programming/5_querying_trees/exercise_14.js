...
// add minified version of Array.prototype.concatAll as this is referenced by concatMap | exercise 10
Array.prototype.concatAll=function(){var n=[];return this.forEach(function(o){o.forEach(function(o){n.push(o)})}),n};
// add minified version of Array.prototype.concatMap | exercise 13
Array.prototype.concatMap=function(t){return this.map(function(n){return t(n)}).concatAll()};
